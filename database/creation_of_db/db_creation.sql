...
CREATE TABLE SERVICE_PROVIDER (
	PROVIDER_ID NUMBER CONSTRAINT PROVIDER_PK PRIMARY KEY,
...
CREATE TABLE CATEGORY ( CATEGORY_ID NUMBER CONSTRAINT CATEGORY_PK PRIMARY KEY, CATEGORY_NAME VARCHAR2 ( 50 ) NOT NULL, DESCRIPTION VARCHAR2 ( 500 ) );

CREATE TABLE SERVICE (
	SERVICE_ID NUMBER CONSTRAINT SERVICE_PK PRIMARY KEY,
...
CREATE TABLE PAYMENT_INFO ( PAYMENT_ID NUMBER CONSTRAINT PAYMENT_INFO_PK PRIMARY KEY, AMOUNT NUMBER NOT NULL, METHOD VARCHAR2 ( 20 ) NOT NULL, TRANSACTION_ID VARCHAR2 ( 30 ) );
ALTER TABLE ORDERS ADD CONSTRAINT FK_ORDEREDBY FOREIGN KEY ( C_ID ) REFERENCES CUSTOMER ( CUSTOMER_ID ) ON DELETE 
SET NULL;
ALTER TABLE ORDERS ADD CONSTRAINT FK_PAY FOREIGN KEY ( PAYMENT_ID ) REFERENCES PAYMENT_INFO ( PAYMENT_ID ) ON DELETE 
SET NULL;
...
MODERATOR_ID NUMBER CONSTRAINT MODERATOR_PK PRIMARY KEY,
...
TRANSACTION_ID NUMBER CONSTRAINT ACCOUNT_PK PRIMARY KEY,
DEBIT NUMBER,
CREDIT NUMBER,
